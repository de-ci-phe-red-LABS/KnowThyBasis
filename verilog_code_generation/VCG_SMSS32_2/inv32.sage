...
for g in H:
      ...
      for index in T:
            ...
            U=matrix(GF(2),X);
            V=U.transpose();		
            fname = f'/home/dilip/Desktop/6-bit_Sbox/Inv/inv_nn/inv_nn_{k}_{l}.v'
            with open(fname, "w") as f:
                  f.write("`timescale 1ns/100ps;\n");
                  f.write("module inv_nn_{}_{}(x,y);\n".format(k,l));
                  f.write("\t input [5:0] x;\n");
                  f.write("\t output [5:0] y;\n");
                  f.write("\t wire [5:0] w;\n");
                  f.write("\t wire [5:0] p;\n");
                  f.write("\t isomorphism C2 (x,w);\n");
                  f.write("\t power_62 C3 (w,p);\n");
                  ...
                  f.write("\t square_base A2 (x_2,x_3);\n");
