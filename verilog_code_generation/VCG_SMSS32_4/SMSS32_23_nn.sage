...
for g in H:
	...
	for index in Index[k-1]:
		...
		for i1 in range(63):
		    if((t^i1==b)):
			    p=i1;
		B1=[(s+21*p)%63,(2*s+21*p)%63,(4*s+21*p)%63,(s+168*p)%63,(2*s+168*p)%63,(4*s+168*p)%63];
		X=[];
		for i in B1:
		    for i1 in F:
			    for i2 in F:
		...
		U=matrix(GF(2),X);
		V=U.transpose();		
		fname = f'/home/dilip/Desktop/6-bit_Sbox/supplementary_material/verilogcode/SMSS32_4/SMSS32_23_nn_{k}_{l}.v'
		with open(fname, "w") as f:
			f.write("`timescale 1ns/100ps;\n");
			f.write("module SMSS32_23_nn_{}_{}(x,y);\n".format(k,l));
			f.write("\t input [5:0] x;\n");
			f.write("\t output [5:0] y;\n");
			f.write("\t wire [5:0] w;\n");
			f.write("\t wire [5:0] p;\n");
			f.write("\t isomorphism C2 (x,w);\n");
			f.write("\t power_23 C3 (w,p);\n");
			...
			f.write("\t wire [2:0] x_8;\n");
			f.write("\t wire [2:0] x_9;\n");
			f.write("\t wire [2:0] x_10;\n");
			f.write("\t wire [2:0] x_11;\n");
			...
			f.write("\t add_base A3 (x_2,x_3,x_4);\n");
			f.write("\t multiplication_base A4 (x_0,x_1,x_5);\n");
			f.write("\t square_base A5 (x_5,x_11);\n");
			f.write("\t add_base A6 (x_4,x_5,x_6);\n");
			f.write("\t multiplication_base A7 (x_4,x_11,x_7);\n");
			f.write("\t multiplication_base A8 (x_6,x_7,x_8);\n");
			f.write("\t multiplication_base A9 (x_1,x_8,x_9);\n");
			f.write("\t multiplication_base A10 (x_0,x_8,x_10);\n");
			f.write("\t add_base A11 (x_3,x_9,y_0);\n");
			f.write("\t add_base A12 (x_2,x_10,y_1);\n");
