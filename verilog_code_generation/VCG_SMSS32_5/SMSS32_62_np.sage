...
for g in H:
	...
	for index in T:
		...
		U=matrix(GF(2),X);
		V=U.transpose();		
		fname = f'/home/dilip/Desktop/6-bit_Sbox/supplementary_material/verilogcode/SMSS32_5/SMSS32_62_np_{k}_{l}.v'
		with open(fname, "w") as f:
			f.write("`timescale 1ns/100ps\n");
			f.write("module SMSS32_62_np_{}_{}(x,y);\n".format(k,l));
			f.write("\t input [5:0] x;\n");
			f.write("\t output [5:0] y;\n");
			f.write("\t wire [5:0] w;\n");
			f.write("\t wire [5:0] p;\n");
			f.write("\t isomorphism C2 (x,w);\n");
			f.write("\t inverse C3 (w,p);\n");
			...
			f.write("\t wire [3:0] u;\n");
			f.write("\t output [2:0] c;\n");
			f.write("\t assign t[0]=(a[0]&b[0]);\n");
			f.write("\t assign t[1]=(a[0]&b[1]);\n");
			f.write("\t assign t[2]=(a[0]&b[2]);\n");
			f.write("\t assign s[0]=(a[1]&b[0]);\n");
			f.write("\t assign s[1]=(a[1]&b[1]);\n");
			f.write("\t assign s[2]=(a[1]&b[2]);\n");
			f.write("\t assign u[0]=(a[2]&b[0]);\n");
			f.write("\t assign u[1]=(a[2]&b[1]);\n");
			f.write("\t assign u[2]=(a[2]&b[2]);\n");
			f.write("\t assign t[3]=s[2]^u[1]^u[2];\n");
			f.write("\t assign c[0]=t[0]^t[3];\n");
			f.write("\t assign c[1]=t[1]^s[0]^u[2];\n");
			f.write("\t assign c[2]=u[0]^s[1]^t[2]^t[3];\n");
			f.write("endmodule\n");
			f.write("\n")
			...
			f.write("endmodule\n");
			f.write("\n")
			f.write("module six_base(a,b);\n");
			f.write("\t input [2:0] a;\n");
			f.write("\t wire [4:0] t;\n");
			f.write("\t output[2:0] b;\n");
			f.write("\t assign t[0]=(a[0]&a[1]);\n");
			f.write("\t assign t[1]=(a[0]&a[2]);\n");
			f.write("\t assign t[2]=(a[1]&a[2]);\n");
			f.write("\t assign t[3]=t[0]^t[2];\n");
			f.write("\t assign t[4]=a[2]^t[3];\n");
			f.write("\t assign b[0]=a[0]^t[1]^t[4];\n");
			f.write("\t assign b[1]=a[1]^t[4];\n");
			f.write("\t assign b[2]=a[1]^t[1]^t[2];\n");
			f.write("endmodule\n");
			f.write("\n")
			f.write("module inverse(a,b);\n");
			f.write("\t input [5:0] a;\n");
			...
			f.write("\t add_base A1 (x_0,x_1,x_2);\n");
			f.write("\t square_base A2 (x_1,x_3);\n");                  
			f.write("\t multiplication_base A3 (x_0,x_2,x_4);\n");
			f.write("\t add_base A4 (x_3,x_4,x_5);\n");
			f.write("\t six_base A5 (x_5,x_6);\n");
			f.write("\t multiplication_base A6 (x_1,x_6,y_0);\n");
			f.write("\t multiplication_base A7 (x_0,x_6,y_1);\n");
			f.write("\t assign b[0]=y_0[0];\n");
			f.write("\t assign b[1]=y_0[1];\n");
			f.write("\t assign b[2]=y_0[2];\n");
			f.write("\t assign b[3]=y_1[0];\n");
			f.write("\t assign b[4]=y_1[1];\n");
			f.write("\t assign b[5]=y_1[2];\n");
			f.write("endmodule\n");
			V0=[];
			V1=[];
			V2=[];
